				...
				<div class="col-sm-9 page">
					<div class="d-flex justify-content-center">
						...
						<div class="input-group mb-3">
							...
							<input type="email" class="form-control" name="com_id" value="${sessionScope.plogin.com_id }"
								readonly>
						</div>
							...
							<input type="text" class="form-control" name="com_pw" value="${sessionScope.plogin.com_pw }"
								>
						</div>
						...
						<div class="form-floating mb-3">
							...
							<input type="text" class="form-control"
								name="com_tell" value="${ vo.com_tell }" >
						</div>
							...
							<div class="d-flex justify-content-between">
								...
								<button type="button" class="btn btn-dark"
									...
									onClick="location.href='/Company/CInfo?com_id=${ sessionScope.plogin.com_id}class'">취소</button> <!-- 회원탈퇴 페이지 만들고 연결 -->
            </div>
						</form>
