	...
	<div class="container d-flex">
		<div class="list-group mx-2">
			<a href="/Users/Info?user_id=${ sessionScope.plogin.user_id }"
				...
				class="list-group-item shadow">입사지원 관리</a> <a href=""
				...
				<div class="col-sm-9 page">
					<div class="d-flex justify-content-center">
						...
						<div class="input-group mb-3">
							...
							<input type="email" class="form-control" name="user_id" value="${ sessionScope.plogin.user_id }"
								readonly>
						</div>
							...
							<input type="text" class="form-control" name="user_pw" value="${sessionScope.plogin.user_pw}"
								>
						</div>
