...
//		int count = boardPagingMapper.count(vo);
//		PagingResponse<CommunityVo> response = null;
//		if(count < 1) {
...
//        searchVo.setPageSize(10); // 페이지사이즈 3
...
//	    CommunityVo  vo =  communityMapper.getcommunityVo( communityVo );
	    ...
	    // 게시물 정보 가져오기
//	    List<CommunityVo> list = boardPagingMapper.getCBoardPagingList(communityVo, offset, recordSize, recordSize);
